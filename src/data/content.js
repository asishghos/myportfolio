...
export const projects = [
  {
    ...
    description:
      'Cross-platform Flutter app with 90% feature parity to the web version, including user profiles, contest tracking, and competitive programming resources.',
    details: [
      'Used GetX for state management and Firestore for secure data storage.',
      'Integrated secure authentication, platform performance tracking, calendar-based contest reminders, and global tech news access.',
      'Boosted user engagement by 15%; data sourced from the ClistAPI.'
    ],
    links: [
      { label: 'GitHub', href: '#' },
